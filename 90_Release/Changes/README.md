...
- v0.19.0のMinimum AI-native Project Runtimeは、公開済みIDを再利用せず[CHG-000057](CHG-000057_Minimum_AI_Native_Project_Runtime.md)で追跡する。これはv0.18.1の公開後に開始した独立した未リリース変更であり、固定7件のv0.18統合台帳へ吸収しない。
