...
- manifest署名検証、binary取得、fixed image build／digest、argv互換性、配布条件とservice条件の有効化、Provider Home Effect、Mount Grant、Egress Proxy、Telemetry、login／logout、quota probeおよび実Provider probeは[`Product Roadmap`](../../99_Roadmap/01_Product_Roadmap.md)から後続変更として追跡する。
