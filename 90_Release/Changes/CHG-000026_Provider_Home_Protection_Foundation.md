...
固定Commit `e6fdbc6edb52bd757b86e2f40edadf9755692773`／Tree `f94010bb6c316480e1a796a6cc8e8d46bd0e0961`／Parent `320d74f8511500823f7b7b4f2ba9a582b62eae95`の監査集合は、Agent／Architecture／Securityが`Fail`（`AG-HOME-R3-001` Major）、Documentが`Fail`（`DOC-HOME-R3-001` Major）、Gap／Impactが`Fail`（`GCI-HOME-003` Major）、Conformanceが`Fail / Not Eligible`であった。e6監査時の正式4分類literalは3件とも「今回の修正によって新たに発生」であり、当時の結果として保持する。
