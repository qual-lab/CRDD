...
00_CRDD、02_UX、95_Decisionsを変更する場合は、必ず人間承認を求める。
Subagentを利用する場合も、Parent Agentが統合責任を持ち、Canonical Artifactの更新とHuman Review提示を行う。
CRDD文書体系、README / Overview / CHANGELOG、Related Link、Status、採番、Traceabilityに影響する変更では、必要に応じてCRDD Document Audit Agentを使う。
