...
- `08_Quality`には`Quality_Center.md`、`Quality_Strategy.md`、`Verification_Design.md`、`Verification_Results/`を置く。適用の深さでファイル構成を変えず、記述、レビュー、根拠の深さを調整する。検証義務と根拠を中央へ複製しない。
