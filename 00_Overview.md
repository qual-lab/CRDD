...
| `80_Communication` | 外部へ伝える目的、受け手、主張と根拠、公開済み記録、測定と学び候補。必要なRepositoryだけで使用する | [外部コミュニケーション](17_Communication.md) |
...
| `17_Communication.md` | 外部コミュニケーションの目的、受け手、主張と根拠、デザイン方針の接続、公開判断、公開済み記録、測定と学び候補 |
