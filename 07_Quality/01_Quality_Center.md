...
| 対象 | 現在状態 | 根拠・次の処置 |
|---|---|---|
| v0.18.1 Coordinator採用入口 | Source Aの構造是正とローカル契約試験を完了。署名前プレチェック中、未公開 | [候補検証履歴](Verification_Results/2026-09-01_Coordinator_v0181_Runtime_Identity.md)。残る処置はプレチェック収束、署名、fresh clone／submodule一般Task、4経路、Recovery、同一固定候補の独立再確認、人間による統合・Release判断 |
