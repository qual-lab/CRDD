...
義務の所有者は[UX](../02_UX/05_Quality_Expectations.md#2-品質期待台帳)、[IA](../03_IA/01_Information_Architecture.md#6-現在状態と次工程)、[UI](../04_UI/06_Current_Interface_Reference.md#5-アクセシビリティ利用品質の義務)および[仕様](../05_SPEC/07_Current_Behavior_Reference.md#user-interface-contract)。以下は確認方法であり、義務や合否条件を再定義しない。
