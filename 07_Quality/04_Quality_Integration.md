...
| [cros](../06_Architecture/Details/cros/01_Architecture.md) | `cros.surface-contract` | [外部送信とTransport](Definitions/QA-000009/quality_definition.md) | `EST-IT-010` | Covered | CLI／MCP／Workbenchの各入口は同じApplication ContractとOwnerへ接続する |
| [cros](../06_Architecture/Details/cros/01_Architecture.md) | `cros.result-return` | [外部送信とTransport](Definitions/QA-000009/quality_definition.md) | `EST-ST-011` | Covered | 委譲結果は元Task／Revisionへ一度だけ帰還する |
...
| [project-operation](../06_Architecture/Details/project-operation/01_Architecture.md) | `project-operation.context-lifecycle` | [候補の昇格](Definitions/QA-000005/quality_definition.md) | `CPR-IT-004`、`CPR-ST-005`、`CPR-IT-006`、`CPR-UAT-007` | Covered | 物理保存形式はDevelopmentで選択する |
