...
> 後続結果の案内: 本書は2026-08-31の失敗・是正・確認時点の記録を保持する。是正後の署名版4f10201による4経路・復旧・実取消の成功と、現在残る独立確認は[2026-09-01の新しい結果](2026-09-01_Coordinator_Signed_E2E.md)を参照する。本書内の当時の未完了状態を、後続実測が未実施である根拠にしない。
