...
| 確認 | 結果 |
|---|---|
| Coordinator制限Process全回帰 | 1,654件中1,654件成功、失敗・取消・skip 0、301.151秒 |
| Docker Desktop修復Record、Runtime修復、設計追跡の集中確認 | 114件中114件成功、失敗・取消・skip 0、7.59秒 |
| Docker Task Recovery契約 | 106件中106件成功、失敗・取消・skip 0、111.24秒 |
| TypeScript型検査 | 2構成とも成功 |
| Runtime設計追跡 | 資源10、状態23、遷移23、不変条件12、検証対応14で成功 |
