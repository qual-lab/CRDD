...
Roadmap項目は、完了させる変更の一覧ではなく、何が成立すれば次の到達点へ進めるかを示せる。着手を決めた時点で、現行改訂版と対象差分を再確認し、必要な変更トレースへ接続する。変更トレースはRoadmapの方向や課題探索・要求形成の意味を複製せず、現在状態、変更対象、保持する意図、影響、実装、検証およびRelease処置を所有する。
