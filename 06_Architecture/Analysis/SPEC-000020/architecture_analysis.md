...
| UX分析 | 保持する利用者成果 |
|---|---|
| [UX-000023](../../../05_SPEC/Analysis/UX-000023/spec_analysis.md) | 監査・是正・判断を一つの改訂版で閉じる |
| [UX-000026](../../../05_SPEC/Analysis/UX-000026/spec_analysis.md) | 試験層と現在の保証範囲を理解して選ぶ |
| [UX-000029](../../../05_SPEC/Analysis/UX-000029/spec_analysis.md) | 作業・変更・根拠・品質を迷わず辿る |

### IA観点の分析結果

| IA分析 | 保持する情報構造 |
|---|---|
| [IA-000016](../../../05_SPEC/Analysis/IA-000016/spec_analysis.md) | 変更・指摘・是正・試験・品質 |
...
| Failure／Recovery | 評価済み | 試験件数や一部監査完了から全体Passを推定しない。Recoveryは入力定義にある場合だけ保持する。 |
