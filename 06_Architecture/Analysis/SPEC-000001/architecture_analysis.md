...
| UX分析 | 保持する利用者成果 |
|---|---|
| [UX-000001](../../../05_SPEC/Analysis/UX-000001/spec_analysis.md) | 意味レビューへ集中できる事前確認 |

### IA観点の分析結果

| IA分析 | 保持する情報構造 |
|---|---|
| [IA-000001](../../../05_SPEC/Analysis/IA-000001/spec_analysis.md) | 検査対象・条件・指摘 |
...
| Failure／Recovery | 評価済み | 入力不備、対象不明、検査不能を成功へ畳まず、変更を発生させない。Recoveryは入力定義にある場合だけ保持する。 |
