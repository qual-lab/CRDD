...
| UX分析 | 保持する利用者成果 |
|---|---|
| [UX-000006](../../../05_SPEC/Analysis/UX-000006/spec_analysis.md) | 実行事実を根拠付きで振り返る |

### IA観点の分析結果

| IA分析 | 保持する情報構造 |
|---|---|
| [IA-000004](../../../05_SPEC/Analysis/IA-000004/spec_analysis.md) | 実行事実・観測・評価 |
...
| Failure／Recovery | 評価済み | 欠測を正常値へ補完せず、評価を観測事実として返さない。Recoveryは入力定義にある場合だけ保持する。 |
