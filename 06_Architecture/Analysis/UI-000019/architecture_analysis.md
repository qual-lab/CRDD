...
| UX分析 | このUIで保持する利用者成果 |
|---|---|
| [UX-000030](../../../04_UI/Analysis/UX-000030/ui_analysis.md) | 公式素材の出所・原本・派生物・利用条件を確認し、許可された用途で安心して収載・再利用できる |

### IA観点の分析結果

| IA分析 | このUIで保持する情報構造 |
|---|---|
| [IA-000019](../../../04_UI/Analysis/IA-000019/ui_analysis.md) | 公式素材を、見た目ではなく由来・権利・許可用途を確認して利用する。 |

### 両観点の統合判断

| UX分析 | 利用者が得たい結果 | 対応するIA分析 | UIで成立させる対応 |
|---|---|---|---|
| [UX-000030](../../../04_UI/Analysis/UX-000030/ui_analysis.md) | 公式識別へ安心して収載・派生利用できる | [IA-000019](../../../04_UI/Analysis/IA-000019/ui_analysis.md) | 素材（Asset）、情報源（Source）、権利確認（Rights Statement）、許可用途（Allowed Use）、派生物（Derivative）を見分ける。状態は「候補（candidate）／採用済み（approved）／開示制限（restricted）／取下げ済み（withdrawn）」。導線は「素材→由来→権利→用途→収載・派生」 |
