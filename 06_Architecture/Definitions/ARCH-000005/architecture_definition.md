...
|---|---|---|---|---|---|
| 基準版なし | なし（v0.22新規） | Project Management Projection／Objective・Milestone Acceptance Decision Record | 新規 | 実装Evidence未作成 | 読取り投影の物理Schema／Workbench実測と、受入判断Port／Recordの実装・試験Evidenceが未接続 |
