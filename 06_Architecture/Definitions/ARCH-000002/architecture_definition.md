...
|---|---|---|---|---|---|
| [SCR-000014／PRT-000014](../../../04_UI/Details/Areas/governance/SCR-000014/screen.md) | UI-000014 | Screen／Partの配置、情報優先度、操作、FeedbackおよびState | Source UIとの直接Relation | Covered | v0.22固有LayoutはUI Detailへ戻す |
| [BHV-000019](../../../05_SPEC/Details/BHV-000019/behavior.md) | SPEC-000019 | Trigger、Authority、Validation、State、Effect、Result、FailureおよびRecovery | Source SPECとの直接Relation | Covered | Behavior意味の変更はSPEC Detailへ戻す |
