...
|---|---|---|---|---|---|
| [SCR-000020／PRT-000020](../../../04_UI/Details/Areas/operation/SCR-000020/screen.md) | UI-000020 | Screen／Partの配置、情報優先度、操作、FeedbackおよびState | Source UIとの直接Relation | Covered | v0.22固有LayoutはUI Detailへ戻す |
| [BHV-000030](../../../05_SPEC/Details/BHV-000030/behavior.md) | SPEC-000030 | Trigger、Authority、Validation、State、Effect、Result、FailureおよびRecovery | Source SPECとの直接Relation | Covered | Behavior意味の変更はSPEC Detailへ戻す |
