...
- [`40_Develop/execution-intelligence/.gitignore`](<../../../40_Develop/execution-intelligence/.gitignore>)
- [`40_Develop/execution-intelligence/package-lock.json`](<../../../40_Develop/execution-intelligence/package-lock.json>)
- [`40_Develop/execution-intelligence/package.json`](<../../../40_Develop/execution-intelligence/package.json>)
- `40_Develop/execution-intelligence/README.md`（削除または旧Path）
...
- [`40_Develop/execution-intelligence/src/internal/plain-data-snapshot.ts`](<../../../40_Develop/execution-intelligence/src/internal/plain-data-snapshot.ts>)
...
- [`40_Develop/execution-intelligence/tests/fixtures/execution-intelligence-store-writer.ts`](<../../../40_Develop/execution-intelligence/tests/fixtures/execution-intelligence-store-writer.ts>)
...
- [`40_Develop/execution-intelligence/tsconfig.json`](<../../../40_Develop/execution-intelligence/tsconfig.json>)
...
- [`40_Develop/mcp/src/internal/plain-data-snapshot.ts`](<../../../40_Develop/mcp/src/internal/plain-data-snapshot.ts>)
...
現在の固定候補に対する決定論的な縦断結果は、[v0.20公開Runtimeと限定分散の検証結果](../../Releases/v0.20.0/Evidence/260906_v020-public-runtime-and-bounded-integration-verification.md)へ記録する。以前の独立再レビュー済み範囲を拡張したため、今回追加した組込みRecorder、利用量の部分観測および限定分散評価は、最終一括監査前の独立レビュー対象とする。
