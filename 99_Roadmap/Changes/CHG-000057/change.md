...
正本: [Discovery](../../../01_Discovery/Analysis/EXP-000008/exploration.md)、[UX](../../../02_UX/04_Service_Blueprint.md#5-節目を委ねる)、[IA](../../../03_IA/01_Information_Architecture.md#4-全体の情報構造)、[UI](../../../04_UI/06_Current_Interface_Reference.md#8-project-runtimeの状態表示)、[振る舞い仕様](../../../05_SPEC/07_Current_Behavior_Reference.md#project-runtime-contract)、[参照アーキテクチャ](../../../06_Architecture/Details/project-runtime/01_Architecture.md)、[検証設計](../../../07_Quality/03_Verification_Design.md#project-runtime-verification)
...
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Acknowledgement_Closure_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Audit_Remediation_Focused_Test_Supplement.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Audit_Remediation_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Final_Pre_Sign_Audit.md`（削除または旧Path）
...
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Projection_Bounds_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-03_Project_Runtime_Source_A_Pre_Sign_Audit.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-04_Cross_Login_Recovery_Closure_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-04_Project_Runtime_E2E_Observation_Closure_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-04_Project_Runtime_Process_Close_Closure_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-04_Project_Runtime_Recovery_E2E_Pre_Sign_Verification.md`（削除または旧Path）
- `07_Quality/Verification_Results/2026-09-04_Project_Runtime_Terminal_Observation_Closure_Pre_Sign_Verification.md`（削除または旧Path）
...
- `40_Develop/coordinator/src/security/project-runtime-integration-result.ts`（削除または旧Path）
- `40_Develop/coordinator/src/security/project-runtime-integration.ts`（削除または旧Path）
...
- `40_Develop/coordinator/tests/docker-desktop-repair-history-publication.contract.test.ts`（削除または旧Path）
...
- [`40_Develop/coordinator/tests/fixtures/project-runtime-lease-interleaving-probe.ts`](<../../../40_Develop/coordinator/tests/fixtures/project-runtime-lease-interleaving-probe.ts>)
...
- `40_Develop/coordinator/tests/helpers/docker-desktop-repair-history-publication-testing.ts`（削除または旧Path）
...
- `40_Develop/coordinator/tests/project-runtime-candidate-integration-adapter.integration.test.ts`（削除または旧Path）
- `40_Develop/coordinator/tests/project-runtime-design-traceability.contract.test.ts`（削除または旧Path）
...
- `40_Develop/coordinator/tests/project-runtime-real-provider-verification-script.contract.test.ts`（削除または旧Path）
- `40_Develop/coordinator/tests/project-runtime-replanning-and-decision.contract.test.ts`（削除または旧Path）
...
- `40_Develop/coordinator/tests/project-runtime-windows-decision-store.contract.test.ts`（削除または旧Path）
...
- [`40_Develop/project-runtime/package-lock.json`](<../../../40_Develop/project-runtime/package-lock.json>)
...
- [`40_Develop/project-runtime/tsconfig.json`](<../../../40_Develop/project-runtime/tsconfig.json>)
...
- `90_Release/Changes/Evidence/CHG-000057_Project_Runtime_Real_Provider_E2E_d44ae1a.json`（削除または旧Path）
- `90_Release/Changes/Evidence/CHG-000057_Project_Runtime_Real_Provider_E2E_d44ae1a.md`（削除または旧Path）
- `90_Release/Changes/Evidence/CHG-000057_Project_Runtime_Self_Application_0acc157.json`（削除または旧Path）
- `90_Release/Changes/Evidence/CHG-000057_Project_Runtime_Self_Application_0acc157.md`（削除または旧Path）
...
- [`99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-audit-remediation-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-audit-remediation-pre-sign-verification.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-final-pre-sign-audit.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-final-pre-sign-audit.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-projection-bounds-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-projection-bounds-pre-sign-verification.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-source-a-pre-sign-audit.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260903_project-runtime-source-a-pre-sign-audit.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260903-0352_project-runtime-real-provider-e2e.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260903-0352_project-runtime-real-provider-e2e.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260903-0407_project-runtime-self-application.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260903-0407_project-runtime-self-application.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260904_cross-login-recovery-closure-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260904_cross-login-recovery-closure-pre-sign-verification.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-e2e-observation-closure-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-e2e-observation-closure-pre-sign-verification.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-process-close-closure-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-process-close-closure-pre-sign-verification.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-recovery-e2e-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-recovery-e2e-pre-sign-verification.md>)
- [`99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-terminal-observation-closure-pre-sign-verification.md`](<../../../99_Roadmap/Changes/CHG-000057/Evidence/260904_project-runtime-terminal-observation-closure-pre-sign-verification.md>)
...
- [`99_Roadmap/Releases/v0.19.0/Evidence/260903_project-runtime-final-signed-e2e.md`](<../../../99_Roadmap/Releases/v0.19.0/Evidence/260903_project-runtime-final-signed-e2e.md>)
- [`AGENTS.md`](<../../../AGENTS.md>)
...
| 根拠 | [最終署名E2E](../../Releases/v0.19.0/Evidence/260903_project-runtime-final-signed-e2e.md)、[Source A署名前監査](./Evidence/260903_project-runtime-source-a-pre-sign-audit.md)、[最終署名前監査](./Evidence/260903_project-runtime-final-pre-sign-audit.md)、[検証設計](../../../07_Quality/03_Verification_Design.md#project-runtime-verification) |
...
[Project状態契約試験](../../../40_Develop/project-runtime/tests/unit/project-runtime-state.contract.test.ts)は、最大5件選択、Dependency、Path／Conflict、cleanup不明、Recovery、古い世代、Graph不正に加え、Task完了後の統合待ち、Objective／Milestoneの段階受入、Evidence不足、Recovery時の成功補正禁止を確認する。[MCP Adapter契約試験](../../../40_Develop/mcp/tests/unit/project-runtime-adapter.contract.test.ts)は、薄い単一Task経路とAdapter固有Authority 0を維持する。
...
[監査是正後の署名前検証](./Evidence/260903_project-runtime-audit-remediation-pre-sign-verification.md)では、技術候補`3661c3a`について制限Process試験1,566件、Windows実資源Gate 7件、関連試験147件、設計追跡および文書チェッカーがすべて成功した。Tombstone 64+1、回収後の古いReceipt再出現、物理Receiptと古いProject attemptの組合せ、Objective別MCP到達可能性、および部分再計画の完了・拒否を反証試験で固定した。過去の署名前検証は各記録時点のblobを保持し、現在候補の根拠へ上書きしない。この結果は独立再監査へ進める決定論的な技術候補の成立であり、残る実Provider・実Docker・認証済みMCP ClientのE2Eを代替しない。

同候補の独立再監査では前回指摘の解消を確認した一方、公開ProjectionのObjective別件数を配列へ展開する実装が、最大安全整数等の未信頼な内部結果によって例外または巨大割当へ至る是正起因のMajorを検出した。技術候補`45409e5`ではProject入力と同じObjective 128件、Task 1,024件の上限をAdapterとCoreの両方で固定長の算術検証へ接続し、Task 1,025件、最大安全整数および複数Objectiveの合計超過を例外なしで固定の不正結果へ閉じた。[公開件数境界に関する署名前検証](./Evidence/260903_project-runtime-projection-bounds-pre-sign-verification.md)で関連147件、制限Process 1,566件、Windows実資源Gate 7件および全決定論的確認の成功を記録した。この時点では独立再監査待ちであり、後段E2EまたはReleaseの成立を意味しなかった。

[最終署名前監査](./Evidence/260903_project-runtime-final-pre-sign-audit.md)では、固定改訂版`661de97`に対する文書・規範、Runtime状態・回復・再計画、および公開MCP投影・例外境界の3系統がCritical 0、Major 0、Minor 0でPassした。前回Majorの解消、以前の回復・再計画是正の維持、設計からEvidenceまでの伝播および未完了表示を確認した。この結果は当該固定改訂版の履歴であり、後続の実Provider E2E検証器変更へ自動継承しない。

その後、最終E2E検証器の独立事前確認で、正常2経路を同じ公開MCP Processへ集約するとObjectiveごとのProvider選定、Process開始、正本差分を相関できないこと、および選定通知直後の取消では実Provider Process開始後の取消を証明できないことを検出した。技術候補`545933f`では正常経路をObjectiveごとの別Processへ分離し、各実行の選定、Runtime所有のProcess開始観測、前後Repository snapshotおよび期待する正本状態をexactに照合する。取消は対象Provider Process開始のRuntime通知後だけ発行し、同じObjectiveの取消状態、固定理由、cleanup、Effect、Recoveryおよび正本不変を一体で検証する。集約上は異なるProviderに見える同一Provider実行、非採用経路だけの正本変更、開始前取消および取消結果の成功理由を反証試験で拒否した。制限Process試験1,574件、Windows実資源Gate 7件、Coordinator全確認は成功した。独立再確認と署名後最終E2Eは未完了であり、以前の署名前監査Passを現在候補のPassへ読み替えない。

`545933f`の独立再確認では、開始通知が実Provider ProcessではなくDocker Controller起動時点に置かれ、下位結果が`providerRequestStarted: false`のままでも開始済みと扱えること、および必要イベントの存在確認だけでは余分・重複イベントを拒否できないことをMajorとして検出した。技術候補`4ba16b6`ではProvider commandの`startCommand`がlive handleを返した直後へ通知を移し、同期開始失敗では通知を発行せず、通知失敗では取得済みhandleを停止してFail Closedにする。検証器はRuntimeの固定prefixだけを入力とし、選定とProcess開始を期待する順序・役割・Provider・一意なOperation IDの閉集合として照合する。余分、重複、埋め込み診断JSONおよび開始前取消の反証試験を追加し、制限Process試験1,576件、Windows実資源Gate 7件、Coordinator全確認は成功した。独立再確認と署名後最終E2Eは未完了である。

`4ba16b6`の独立再確認では、Node.jsの`spawn()`からhandleが返ることとOSの起動成功が同一でなく、非同期の起動失敗でも開始通知へ進み得ること、productionの標準エラー通知が書込み完了・stream失敗を観測していないこと、および選定／開始を別配列で照合すると両者をまたぐ順序違反とrun間のOperation ID再利用を検出できないことをMajorとして検出した。技術候補`2518ecd`は、OSの`spawn` acknowledgement、有効なPIDと標準入出力を確認した後だけProvider開始を成立させ、同期・非同期起動失敗、通知のerror／close／timeoutをProcess停止と成功拒否へ閉じた。検証器は選定と開始を一つの順序付きevent列として照合し、正常2経路と取消を含む全run間でOperation IDの形式と一意性を確認する。実子Process fixtureは特別な`.mjs`を残さずRepositoryのTypeScript規則へ統一した。制限Process試験1,579件、Windows実資源Gate 7件、fixture変更後の対象試験8件およびCoordinator全確認は成功した。独立再確認はCritical／Major／Minor 0件でPassし、前回Major 3件の解消と、Provider選定、外部送信Authority、Recovery／adoption、署名IdentityおよびPlatform境界への意図外変更がないことを確認した。

[Source A署名前監査](./Evidence/260903_project-runtime-source-a-pre-sign-audit.md)では、初回固定改訂版でRelease closure契約の不一致と、実行環境の意味・是正影響の公開伝播不足をMajor 2件として検出した。Source A、Manifest-only B、許可済み文書だけのFinal Candidate C、PR、main、tagを一つの閉じた経路へ統一し、B→Cを事前宣言したexact Pathへ限定した。英日CHANGELOGとRoadmapにも一般化した意味を伝播した。是正後固定改訂版`1f3f49b`の限定再確認はCritical／Major／Minor 0件でPassした。これはSource Aの署名適格性であり、署名後最終E2Eは未完了である。

後続の全体試験では、Repository Binding単位Leaseの別Process競合が、正常な同時取得中に見える一時fileを回復残存と誤認し、不要な手動回復を要求する非決定的失敗を検出した。単独成功を根拠に除外せず反復再現し、取得中Markerは一意な準備fileへ完全にwrite、flush、close、readbackしてから排他的hard linkで最終Pathへ公開する方式へ変更した。ところが最初の是正は、両Processが最終Pathの不存在を先に見た一順序しか覆わず、準備中または保持中のownerへ後着した取得を依然として回復残存へ誤分類していた。署名前プレチェックでこれをMajorとして検出し、取得経路は既存の準備file、公開済みMarkerまたはLock所有Markerを常に取得不可、手動回復不要、Effect 0として扱い、owner喪失の判断と資源回収をfreshな専用reconciliationだけへ分離した。実Process試験は、完全取得後の後着、最終公開直前の後着、owner生存中の非変更、Process終了後のexact Recovery、公開後の準備file除去不明および旧一時fileを固定する。別Process競合の反復試験も同時所有0と不要な手動回復0を要求する。是正後は関連試験33件、3 Process競合20回、制限Process試験1,595件、Windows実資源Gate 7件およびCoordinator全確認が成功した。これは署名前の追加候補であり、更新した固定改訂版の独立確認前に解消済みへ昇格しない。

次の署名前プレチェックでは、専用reconciliationが低層契約試験からだけ到達でき、Queue ownerへの公開前停止では本番入口が呼び出さない接続漏れを検出した。是正後の公開Objective入口は、Repository Binding単位の取得資源を読取り専用で調べ、Markerが示す実際の元Queueを解決したうえでfreshなPlatform owner観測へ渡す。現在受付中のQueueを残存資源の所有者と推定しない。正本採用入口も同じPlatform owner観測を採用Lease取得前へ接続する。owner生存中の後着はEffect 0で待機し、公開前に停止したProcessの不存在を確認できた場合だけexact Recoveryへ収束する。不正・複数の取得証跡は削除せず、公開結果へ同じ非Authority回復参照を返す。公開Objective再入場と正本採用のProcess停止試験、および不正・複数証跡の非変更試験を追加した。低層関数の直接試験だけを利用側接続の根拠にしない。

同じ固定候補の独立再監査では、Integration Coreへ追加した回復参照がMCPの閉じた結果契約へ伝播していないことと、共有取得MarkerからQueueだけを解決して現在要求のProjectを流用していたことを検出した。両者を公開契約伝播の一つの是正として扱い、Integration結果のfield集合・回復参照・相関をCore所有のCanonical検証契約へ固定してMCPの重複定義を除いた。共有取得資源はQueue正本から実Project、Queue、ownerおよび回復IDまで解決する。同一Projectのexact Queueだけを自動回復対象とし、別Project、Queue欠落またはQueue履歴不正では、新しいProject State／Queueも既存資源も変更せず、Binding単位のexactな非Authority回復参照を返す。実Producerから公開RuntimeとMCPへ至る正常結果、回復参照を持つ異常結果、別Project・欠落・不正Queueの非変更を縦断確認する。
...
最終監査では、署名後E2Eが通常終了と取消後のDocker状態をcleanと確認するだけで`recoverySettlementExercised`を真にでき、宣言済みのParent喪失からの実回復を実行していないことをMajorとして検出した。技術候補`ec4f9ea`は、署名済み公開MCPから実Provider Process開始を観測した後にその親Process treeを停止し、freshな署名済み公開MCPへ同じObjectiveを再送する。Runtimeが耐久境界ごとに観測した`required → recovering → settled → acknowledged → verification_resources_finalized → queue_settled → retry_ready`を、同じProject／Milestone／Queue／Task／Operation／Recovery Identityへ結合し、再入場後の受入、正本不変、子Process終了および最終Docker資源不存在まで成立した場合だけ実回復完了と判定する。診断出力は非Authorityの検証投影であり、ClientへRecovery IDまたは回復権限を入力させない。[実回復E2Eの署名前検証](./Evidence/260904_project-runtime-recovery-e2e-pre-sign-verification.md)では、関連40件、制限Process試験1,604件、Windows実資源Gate 7件、Coordinator全確認および文書チェッカーが成功した。更新固定版の独立再監査および署名後実測は未完了であり、決定論的確認だけを実回復成立へ読み替えない。

`37b629f`の独立監査では、Runtime所有prefixを使っていても生の標準エラー文字列を操作Triggerにしていたこと、Child Processの終了とProcess tree終了の確認を分離できていなかったこと、回復EventのQueue／Task相関が不足していたこと、および診断streamのcallback・error・close・timeoutを一つの完了へ畳んでいたことをMajor 3件として検出した。局所修正を開始せず、Producer別Event Schema、増分parser、Process終了owner、7段階の相関表、診断stream状態、変更禁止範囲および反証試験までを監査担当と事前に合意した。技術候補`c574e13`は合意した閉集合を実装し、反証試験で不正Event後の操作発火、chunk／CRLF／EOF、役割・Provider差、Queue／Task／Operation差、診断の遅延通知およびhelper境界を固定した。[E2E観測契約の署名前検証](./Evidence/260904_project-runtime-e2e-observation-closure-pre-sign-verification.md)は、制限Process試験1,615件、Windows実資源Gate 7件、Coordinator全確認および文書チェッカーの成功を記録する。前の実回復E2E記録は当時の履歴として保持するが、Queue／Task exact相関と診断終端に関する現在Evidenceには流用しない。現在は更新固定版の独立再監査待ちであり、解消済みまたは署名適格とはまだ判定しない。

`c574e13`の独立再監査では、`exit`と`close`を区別する合意は存在したが、`exit`だけが先着し`close`が欠落する反証例を試験へ全数対応しておらず、公開Process観測が永久待機し得る適用漏れをMajorとして検出した。監査担当と、通常観測、入力終了、cleanup要求、実`close`、最終期限、期限後error sink、Process-tree helperおよび共通絶対期限を状態と反証例まで再合意した。技術候補`99b0b2f`は、`exitCode`／`signalCode`に依存せず最終期限を発火し、実`close`だけをjoin成立へ使う。期限後は結果用listenerを外し、実際の`close`まで標準入出力とChild Processの遅延errorを非結果化したsinkで所有する。helperの開始不能、待機期限、非0終了、signal、出力超過およびhelper `close`未観測をすべて未確認へ閉じる。[Process終了観測の署名前検証](./Evidence/260904_project-runtime-process-close-closure-pre-sign-verification.md)は、集中試験24件、制限Process試験1,625件、Windows実資源Gate 7件、Coordinator全確認および文書チェッカーの成功を記録する。これは更新固定版の独立再監査前にはMajor解消または署名適格を意味しない。

`99b0b2f`の独立再監査では、端末streamの`destroyed`を`closed`相当として扱い遅延`error`の所有を終了していたこと、および通常2経路、取消、親喪失回復、回復再入場の各利用側へ未join反証を全数対応していなかったことをMajorとして検出した。個別修正を開始せず、streamのopen／destroyed-unclosed／closed、helperの開始待機／終了待機、5つの公開利用側を監査担当と具体化し、各条件を実装owner、反証試験、変更禁止範囲へ双方向に対応させた。技術候補`003b72f`は、実`close`前の3 streamへ結果非影響のerror sinkを保持し、既存listenerを変更せず複数の遅延errorを吸収する。helper永久保留、fallback kill成功およびChild `close`欠落が重なっても、共通絶対期限後に未joinを返し、遅延resolveで結果を変えない。[端末資源観測の署名前検証](./Evidence/260904_project-runtime-terminal-observation-closure-pre-sign-verification.md)は、集中試験27件、制限Process試験1,628件、Windows実資源Gate 7件、Coordinator全確認および文書チェッカーの成功を記録する。これは更新固定版の独立再監査前にはMajor解消または署名適格を意味しない。
...
その後の署名済み最終E2E準備では、Docker Desktop修復記録とDocker Task Recoveryが選択ユーザーの安定Identityだけでなく発行時のログオンSession Identityへ結合されており、PC再起動または再ログオン後に同じ利用者が既存Recoveryへ再入場できない構造問題を確認した。局所的にSession比較を外さず、安定Identityを耐久相関、Session Identityを発行時証拠、現在の署名済みRuntime・Root保護・Policy・物理Lock・fresh観測を変更権限として分離した。元記録とRecovery IDは不変とし、再ログオンごとに上限付き・順序付き・改変検知可能な引継ぎ記録を追加する。終了済みの旧Docker Desktop修復は、現在Dockerが利用不能でもEffect 0で履歴採用と終了を記録し、現在障害は別Operationへ分離する。未終了修復は段階別に再開・観測収束・同一ID停止へ分類し、Task Recoveryは同じIDで現在Sessionへ再結合する。再起動Fenceは引継ぎだけでは成立させない。関連する正常、境界変更、改変、Lock再取得、複数Sessionおよび連鎖上限の契約試験を追加した。[再ログオン回復の署名前検証](./Evidence/260904_cross-login-recovery-closure-pre-sign-verification.md)は関連191件、型検査、設計追跡、Lintおよび整形確認の成功を記録する。これは更新固定版の独立再監査前には解消済みまたは署名適格を意味しない。

初回固定版`f78fff4`の独立再監査はCritical 0件、Major 2件、Minor 0件であり、修復履歴を対象へ公開した後に準備ファイルだけが残る中断状態から安全に再入場できないことと、Release引継ぎ連鎖の単調性を各要素間で検証していないことを検出した。局所修正を開始せず、読取り専用分類と対象限定の変更再入場、準備・公開・準備残存の耐久状態、`origin <= adoption <= handoff[0] <= ... <= handoff[n] <= closure <= current boundary`のRelease不変条件、同じSequenceでの署名済みRelease Identity一致、およびTask／修復履歴／耐久公開の直接設計追跡を監査担当と一体で再具体化した。更新候補は、同内容だけで準備ファイルの所有を推定せず対象と同じファイル実体である場合だけ収束し、準備ファイル除去やDirectory確定の失敗を成功へ畳まない。降格、別Release Identity、自己参照、循環、分岐、番号飛び、準備だけ、公開後残存、同内容の別実体および除去失敗を反証試験へ接続した。[再ログオン回復の署名前検証](./Evidence/260904_cross-login-recovery-closure-pre-sign-verification.md)は、制限Process全回帰1,654件、Docker Desktop修復と設計追跡の集中確認114件、Docker Task Recovery 106件、型検査、設計追跡および静的確認の成功を記録する。これは更新固定版の独立再監査前にはMajor解消または署名適格を意味しない。

実Store／実Filesystemを使う縦断確認では、Runtimeが履歴の存在だけで保存済みと判断し、過去Sessionから現在Sessionへの引継ぎを永続化しない利用側伝播漏れを検出した。低層Stubが期待する結果を返していたため、単体の分岐確認では実Storeの状態遷移との差を検出できていなかった。同じMajorクラスタの合意範囲として、不正、履歴なし、終了済み、現在Session、過去Sessionの順序付き分類をRuntimeへ固定し、過去Sessionだけは実Storeへexact 1件の引継ぎを保存するよう是正した。初回採用、Session引継ぎ、終了の各結果は元chainの全fieldと許可差分を検証し、保存後の失敗でも耐久記録をrollbackまたは削除しない。実Store／実Filesystemの同一fixtureで初回採用、同一Session再入場、別Sessionへの1回だけの引継ぎ、終了および終了後Effect 0を縦断した。更新後は集中確認130件、制限Process全回帰1,670件、Windows実Process Gate 7件、Runtime設計追跡25状態／34遷移／15検証対応、Project Runtime設計追跡、Coordinator全確認およびCRDD全体Checkerが成功した。これは更新固定版の独立再監査前にはMajor解消または署名適格を意味しない。

固定候補`e23ba72`の独立再監査はCritical 0件、Major 2件、Minor 1件であり、Runtime履歴の全field相関、耐久公開の競合・故障状態と実Store異常縦断の設計追跡、および試験Adapterの一時領域閉包が未完了であることを検出した。監査担当との再具体化後、初回採用、Session引継ぎ、終了で保持または変更できるfieldを全数検証し、Helper取得不能、境界変化、実Store保存後の返却投影破損を実Filesystemで縦断した。耐久公開は正常、準正常、異常の11状態を個別遷移として正本化し、同byteでは全子ProcessがBarrierへ到達してから収束、異byteでは単一winnerと他者残存の非変更を確認する。試験AdapterはOS一時領域の実Path・非reparse境界へ限定し、本番Coordinator entrypointの依存閉包へ入らないことを機械確認する。更新後は集中確認130件、制限Process全回帰1,670件、実Windows Process Gate 7件、Runtime設計追跡25状態／34遷移／15検証対応、Project Runtime設計追跡、Coordinator全確認およびCRDD全体Checkerが成功した。これは新しい固定改訂版の独立再監査前にはMajor／Minor解消または署名適格を意味しない。
...
Linux／macOS Runtimeの実装、配布、認証、回復および実Provider E2Eはv0.19の対象外とする。一方、Coordinator／Platform責務分離では、Project Runtime Coreへ新しいWindows固有依存を持ち込まず、現在実在するOS依存を[参照アーキテクチャ](../../../06_Architecture/Details/project-runtime/01_Architecture.md)のPlatform Contractへ閉じる。MCPはTransport AdapterとしてPlatform Contractと直交させ、stdio／HTTP等の搬送方式や対象OSが変わってもProject Model、Authority、状態遷移および成功条件を変えない。
