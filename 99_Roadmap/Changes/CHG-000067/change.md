...
| Workbench／MCP共同UX | `Remediation Verification`。固定Commit `edcbd30f`の独立レビュー（Major 4、Moderate 3）を受けた是正を`56880db`で再レビューし、Major 1、Moderate 2まで縮小した。個別REQを一次の自己完結したUX分析、02〜05を横断Synthesis、01を全体俯瞰・Relation台帳として維持する。残っていたSame判断の実Failure比較、Service Blueprintの作成／非該当分類、Not Applicable契約差は一括是正した。加えてUX-IDをSystem接点や品質項目でなく独立した利用者Goal／Outcomeへ発行する基準を固定し、技術語を外しても独立した利用者成果として成立するかを全候補へ適用し、68件を30件へCanonical再編・再採番した。決定論的確認と次の固定候補への独立再レビューがPassするまでIA移行可能とは表示しない |
...
| 旧候補 | 現行UX | 処置 |
|---|---|---|
| `UX-000001` | `UX-000010` | Repository単独で日常作業を続けるの成立要素または同一成果として統合 |
| `UX-000002` | `UX-000009` | Projectの現在地を根拠と不完全性付きで理解するの成立要素または同一成果として統合 |
| `UX-000003` | `UX-000012` | 入口を変えても同じ仕事を続けるの成立要素または同一成果として統合 |
| `UX-000004` | `UX-000014` | Meeting内容を候補化し採否を判断するの成立要素または同一成果として統合 |
| `UX-000005` | `UX-000015` | 複数Projectを根拠付きで比較するの成立要素または同一成果として統合 |
| `UX-000006` | `UX-000009` | Projectの現在地を根拠と不完全性付きで理解するの成立要素または同一成果として統合 |
| `UX-000007` | `UX-000013` | 許可されたWorkspaceだけをRemote利用するの成立要素または同一成果として統合 |
| `UX-000008` | `UX-000021` | 切断後も同じRequestへ戻るの成立要素または同一成果として統合 |
| `UX-000009` | `UX-000005` | 目的と受入条件でMilestoneを委ねるの成立要素または同一成果として統合 |
| `UX-000010` | `UX-000019` | 必要なContextを渡し結果を同じ仕事へ戻すの成立要素または同一成果として統合 |
| `UX-000011` | `UX-000001` | 意味レビューへ集中できる事前確認の成立要素または同一成果として統合 |
| `UX-000012` | `UX-000001` | 意味レビューへ集中できる事前確認の成立要素または同一成果として統合 |
| `UX-000013` | `UX-000002` | 委任範囲と権限を理解して任せるの成立要素または同一成果として統合 |
| `UX-000014` | `UX-000003` | 委任中の状態と判断要否を理解するの成立要素または同一成果として統合 |
| `UX-000015` | `UX-000004` | 失敗後の再試行・回復を選ぶの成立要素または同一成果として統合 |
| `UX-000016` | `UX-000005` | 目的と受入条件でMilestoneを委ねるの成立要素または同一成果として統合 |
| `UX-000017` | `UX-000005` | 目的と受入条件でMilestoneを委ねるの成立要素または同一成果として統合 |
| `UX-000018` | `UX-000006` | 実行事実を根拠付きで振り返るの成立要素または同一成果として統合 |
| `UX-000019` | `UX-000006` | 実行事実を根拠付きで振り返るの成立要素または同一成果として統合 |
| `UX-000020` | `UX-000006` | 実行事実を根拠付きで振り返るの成立要素または同一成果として統合 |
| `UX-000021` | `UX-000007` | 内部変更後も成立済み能力を安全に使うの成立要素または同一成果として統合 |
| `UX-000022` | `UX-000008` | 故障した境界と影響範囲を理解するの成立要素または同一成果として統合 |
| `UX-000023` | `UX-000007` | 内部変更後も成立済み能力を安全に使うの成立要素または同一成果として統合 |
| `UX-000024` | `UX-000012` | 入口を変えても同じ仕事を続けるの成立要素または同一成果として統合 |
| `UX-000025` | `UX-000008` | 故障した境界と影響範囲を理解するの成立要素または同一成果として統合 |
| `UX-000026` | `UX-000009` | Projectの現在地を根拠と不完全性付きで理解するの成立要素または同一成果として統合 |
| `UX-000027` | `UX-000009` | Projectの現在地を根拠と不完全性付きで理解するの成立要素または同一成果として統合 |
| `UX-000028` | `UX-000010` | Repository単独で日常作業を続けるの成立要素または同一成果として統合 |
| `UX-000029` | `UX-000011` | Project・Repository・Rootを区別して対象を選ぶの成立要素または同一成果として統合 |
| `UX-000030` | `UX-000012` | 入口を変えても同じ仕事を続けるの成立要素または同一成果として統合 |
| `UX-000031` | `UX-000013` | 許可されたWorkspaceだけをRemote利用するの成立要素または同一成果として統合 |
| `UX-000032` | `UX-000013` | 許可されたWorkspaceだけをRemote利用するの成立要素または同一成果として統合 |
| `UX-000033` | `UX-000014` | Meeting内容を候補化し採否を判断するの成立要素または同一成果として統合 |
| `UX-000034` | `UX-000014` | Meeting内容を候補化し採否を判断するの成立要素または同一成果として統合 |
| `UX-000035` | `UX-000015` | 複数Projectを根拠付きで比較するの成立要素または同一成果として統合 |
| `UX-000036` | `UX-000016` | 仕事に必要な標準Toolを迷わず選ぶの成立要素または同一成果として統合 |
| `UX-000037` | `UX-000016` | 仕事に必要な標準Toolを迷わず選ぶの成立要素または同一成果として統合 |
| `UX-000038` | `UX-000017` | Runtime Dataを安全に保持・清掃するの成立要素または同一成果として統合 |
| `UX-000039` | `UX-000017` | Runtime Dataを安全に保持・清掃するの成立要素または同一成果として統合 |
| `UX-000040` | `UX-000018` | AIモデル構成を安全に更新・選択するの成立要素または同一成果として統合 |
| `UX-000041` | `UX-000018` | AIモデル構成を安全に更新・選択するの成立要素または同一成果として統合 |
| `UX-000042` | `UX-000019` | 必要なContextを渡し結果を同じ仕事へ戻すの成立要素または同一成果として統合 |
| `UX-000043` | `UX-000019` | 必要なContextを渡し結果を同じ仕事へ戻すの成立要素または同一成果として統合 |
| `UX-000044` | `UX-000019` | 必要なContextを渡し結果を同じ仕事へ戻すの成立要素または同一成果として統合 |
| `UX-000045` | `UX-000020` | 利用環境の信頼方針でRuntimeを選ぶの成立要素または同一成果として統合 |
| `UX-000046` | `UX-000020` | 利用環境の信頼方針でRuntimeを選ぶの成立要素または同一成果として統合 |
| `UX-000047` | `UX-000007` | 内部変更後も成立済み能力を安全に使うの成立要素または同一成果として統合 |
| `UX-000048` | `UX-000021` | 切断後も同じRequestへ戻るの成立要素または同一成果として統合 |
| `UX-000049` | `UX-000022` | 残存資源を安全に回復・清掃するの成立要素または同一成果として統合 |
| `UX-000050` | `UX-000008` | 故障した境界と影響範囲を理解するの成立要素または同一成果として統合 |
| `UX-000051` | `UX-000019` | 必要なContextを渡し結果を同じ仕事へ戻すの成立要素または同一成果として統合 |
| `UX-000052` | `UX-000023` | 監査・是正・判断を一つの改訂版で閉じるの成立要素または同一成果として統合 |
| `UX-000053` | `UX-000023` | 監査・是正・判断を一つの改訂版で閉じるの成立要素または同一成果として統合 |
| `UX-000054` | `UX-000024` | 外部送信範囲と同意を理解して送るの成立要素または同一成果として統合 |
| `UX-000055` | `UX-000019` | 必要なContextを渡し結果を同じ仕事へ戻すの成立要素または同一成果として統合 |
| `UX-000056` | `UX-000025` | 過去の推論Contextと現在値を区別するの成立要素または同一成果として統合 |
| `UX-000057` | `UX-000026` | 試験層と現在の保証範囲を理解して選ぶの成立要素または同一成果として統合 |
| `UX-000058` | `UX-000026` | 試験層と現在の保証範囲を理解して選ぶの成立要素または同一成果として統合 |
| `UX-000059` | `UX-000026` | 試験層と現在の保証範囲を理解して選ぶの成立要素または同一成果として統合 |
| `UX-000060` | `UX-000027` | 物語と構造から文書の意味を理解するの成立要素または同一成果として統合 |
| `UX-000061` | `UX-000028` | 工程固有の図から意図を引き継ぐの成立要素または同一成果として統合 |
| `UX-000062` | `UX-000029` | Work・Change・Evidence・Qualityを迷わず辿るの成立要素または同一成果として統合 |
| `UX-000063` | `UX-000029` | Work・Change・Evidence・Qualityを迷わず辿るの成立要素または同一成果として統合 |
| `UX-000064` | `UX-000029` | Work・Change・Evidence・Qualityを迷わず辿るの成立要素または同一成果として統合 |
| `UX-000065` | `UX-000016` | 仕事に必要な標準Toolを迷わず選ぶの成立要素または同一成果として統合 |
| `UX-000066` | `UX-000016` | 仕事に必要な標準Toolを迷わず選ぶの成立要素または同一成果として統合 |
| `UX-000067` | `UX-000030` | 公式素材を権利と用途を確認して使うの成立要素または同一成果として統合 |
| `UX-000068` | `UX-000010` | Repository単独で日常作業を続けるの成立要素または同一成果として統合 |
