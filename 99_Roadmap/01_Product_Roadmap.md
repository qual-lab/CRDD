...
| v0.18とCoordinator Runtimeの利用者向け入口整理 | Adopted | Planned | [公開入口](../README.md)、[Runtime実装入口](../tools/coordinator/README.md)、[CHG-000015](../90_Release/Changes/CHG-000015_Coordinator_Runtime_1_0.md) | Runtime 1.0の成立範囲を固定した後、最終監査前に、root READMEへv0.18採用による変化、Runtime README上部へ現在できること・起動条件・未成立範囲、Runtime READMEの既存詳細節とThreat Modelへ開発者向けTrust／Provisioning／Recoveryを割り当てて入口を三層へ圧縮する。CHGを利用者入口にせず、実装済み候補、接続済み、実測済み、未実装および非Releaseを混同せず、新しい正本や詳細の複製を増やさない |
