...
| v0.19 推論コンテキストと設計意図 | Adopted | In Progress | [Discoveryの採用境界](../01_Discovery/01_CRDD_Product_Discovery.md#v019-reasoning-context)、[CHG-000058](../90_Release/Changes/CHG-000058_Reasoning_Context_and_Design_Intent.md) | 共通推論要素を固定Schemaにせず、認知推論と選択推論の代表2経路で、AIの変更判断、工程間伝播、逆方向追跡、検証可能性および記録負荷を自己適用する。Project Runtimeとは採否・検証・Release Gateを分離し、片方の未成立を他方の自動停止または部分混入へ読み替えない |
