...
1. 部分接続済みの耐久基盤、単一Task縦断および複数Task制御へ、Platform owner観測と公開Objective Intakeを接続し、その後に再計画、人間判断、統合へ進む。
