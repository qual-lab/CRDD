...
Version: **v0.18.1 Candidate — Coordinator Adoption Interface Correction / Coordinator採用入口の是正**
Released Baseline: **v0.18.0 — Methodology, Agent Organization, and Reference Runtime / 開発手法・エージェント組織・参照Runtime**
