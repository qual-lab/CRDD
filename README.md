...
| 工程移行レビュー | 次工程へ渡す前に、抜けや矛盾を独立した視点で確認すること |
...
6. 工程移行前に[工程移行レビュー](10_Agent.md#72-phase-transition-review-and-remediation-loop)を実行し、責務工程で指摘事項を修正して更新改訂版を再レビューした後に人間の承認へ進む。
