...
|---|---|---|---|
| UX-000024 | IA-000014 | 同意、要求、受理、Effect成立、結果観測、結果不明、投影、採用を分離する | IA-000014 が示す状態・関係を入力条件、成功・停止条件へ接続し、結果不明時は同じ送信依頼へ戻れて二重送信を防ぐ観測可能な結果を確定する |
| UX-000024 | IA-000017 | 同意、要求、受理、Effect成立、結果観測、結果不明、投影、採用を分離する | IA-000017 が示す状態・関係を入力条件、成功・停止条件へ接続し、接続済みを包括許可にせず、外部反応を要求・因果・方針へ自動昇格しない結果を確定する |
