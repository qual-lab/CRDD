...
|---|---|---|---|
| [UX-000002](../../Analysis/UX-000002/ui_analysis.md) | 実行前に誰へ何をどこまで任せるかを理解し、暗黙の範囲拡張なく仕事を委ねられる | [IA-000002](../../Analysis/IA-000002/ui_analysis.md) | 目的、対象範囲、担い手、決定権限、入力、候補、取消、回復を見分ける。利用者向け状態は「準備中／許可待ち／実行中／停止。権限発行前後を分ける」。提案、受付可能、受付済み、拒否は受付FeedbackでありLifecycle状態へ置換しない。導線は「目的→範囲と担い手→許可→実行」。拒否時は新しい依頼を作らず、同じ提案の範囲見直しへ戻る |
...
- 変換根拠: [UX-000002のUI分析](../../Analysis/UX-000002/ui_analysis.md)
- 変換根拠: [UX-000003のUI分析](../../Analysis/UX-000003/ui_analysis.md)
