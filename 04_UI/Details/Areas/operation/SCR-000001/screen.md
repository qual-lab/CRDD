...
- 利用者の作業・認識目的: 機械的な不備と意味判断を分け、直すべき場所へ進める。
- 対象UI Definition: [UI-000001](../../../../Definitions/UI-000001/ui_definition.md)
- Area: [operation](../area.md)
- 入口: 利用者が「事前検査と意味レビューへの案内」を必要とし、対象Contextを識別できた時
- 終了条件: 機械的な不備と意味判断を分け、直すべき場所へ進める。 次の安全な行動または所有正本を選べる
...
|---|---|---|---|---|
| `PRT-000001` | 機械的な不備と意味判断を分け、直すべき場所へ進める。 | 対象、状態、根拠、不足、観測時点、次行動 | 検査を実行する／指摘箇所へ進む。 | ready／pending／blocked／unknown／restricted |

## 3. InteractionとBHV対応

| Interaction Key | PRT | 利用者の意図 | Feedback | BHV | Coverage |
|---|---|---|---|---|---|
| `PRT-000001.spec-000001` | PRT-000001 | 検査を実行する／指摘箇所へ進む。 | 受付、結果、失敗、判断不能および安全な次行動を区別する | [BHV-000001](../../../../../05_SPEC/Details/BHV-000001/behavior.md) | Covered |

## 4. State／Variant

| State／Variant | 発生条件 | 表示する意味 | 操作 | 回復／次の状態 |
|---|---|---|---|---|
| ready | 必要情報とAuthorityを確認できる | 安全に主要操作へ進める | 検査を実行する／指摘箇所へ進む。 | 結果を同じContextで確認 |
