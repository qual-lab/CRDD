...
- Areaの目的: 依頼前の確認から実行、状態把握、外部接続、失敗後の回復、結果記録までを、同じ仕事の識別情報と根拠を保って扱う。
- 主な利用者: CRDDを使って作業、確認または判断する人
- 保持する利用者成果: 依頼前の確認から実行、状態把握、外部接続、失敗後の回復、結果記録までを、同じ仕事の識別情報と根拠を保って扱う。
- 対象UI Definition: [UI-000001](../../../Definitions/UI-000001/ui_definition.md)、[UI-000002](../../../Definitions/UI-000002/ui_definition.md)、[UI-000003](../../../Definitions/UI-000003/ui_definition.md)、[UI-000005](../../../Definitions/UI-000005/ui_definition.md)、[UI-000007](../../../Definitions/UI-000007/ui_definition.md)、[UI-000012](../../../Definitions/UI-000012/ui_definition.md)、[UI-000016](../../../Definitions/UI-000016/ui_definition.md)、[UI-000020](../../../Definitions/UI-000020/ui_definition.md)
...
|---|---|---|---|---|---|
| [SCR-000001](SCR-000001/screen.md) | UI-000001の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000001 | Canonical |
| [SCR-000002](SCR-000002/screen.md) | UI-000002の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000002 | Canonical |
| [SCR-000003](SCR-000003/screen.md) | UI-000003の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000003 | Canonical |
| [SCR-000005](SCR-000005/screen.md) | UI-000005の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000005 | Canonical |
| [SCR-000007](SCR-000007/screen.md) | UI-000007の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000007 | Canonical |
| [SCR-000012](SCR-000012/screen.md) | UI-000012の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000012 | Canonical |
| [SCR-000016](SCR-000016/screen.md) | UI-000016の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000016 | Canonical |
| [SCR-000020](SCR-000020/screen.md) | UI-000020の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000020 | Canonical |
...
- 成功表示だけでAuthority、Effect、結果帰還または清掃完了を推定させる表現。
