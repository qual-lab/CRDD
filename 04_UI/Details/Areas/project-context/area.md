# Project Context Design Guide

成果物種別: UI Area Design Guide
Area Key: `project-context`
状態: Canonical
維持責任者: Qual-Lab

## 1. Areaの目的と利用者成果

- Areaの目的: Project、Repository、会議、文書、履歴および素材の出所を保ち、現在地と次の仕事へ辿れるようにする。
- 主な利用者: CRDDを使って作業、確認または判断する人
- 保持する利用者成果: Project、Repository、会議、文書、履歴および素材の出所を保ち、現在地と次の仕事へ辿れるようにする。
- 対象UI Definition: [UI-000004](../../../Definitions/UI-000004/ui_definition.md)、[UI-000006](../../../Definitions/UI-000006/ui_definition.md)、[UI-000009](../../../Definitions/UI-000009/ui_definition.md)、[UI-000017](../../../Definitions/UI-000017/ui_definition.md)、[UI-000018](../../../Definitions/UI-000018/ui_definition.md)、[UI-000019](../../../Definitions/UI-000019/ui_definition.md)
- 対象外: 実装技術、独自の正本、画面固有の業務規則

## 2. 情報構造と優先順位

```text
対象Project／Repository／Contextを選ぶ
        ↓
現在状態・関係・根拠・現行性を確認
        ↓
正本、候補処置または次工程へ進む
...
|---|---|---|---|---|---|
| [SCR-000004](SCR-000004/screen.md) | UI-000004の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000004 | Canonical |
| [SCR-000006](SCR-000006/screen.md) | UI-000006の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000006 | Canonical |
| [SCR-000009](SCR-000009/screen.md) | UI-000009の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000009 | Canonical |
| [SCR-000017](SCR-000017/screen.md) | UI-000017の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000017 | Canonical |
| [SCR-000018](SCR-000018/screen.md) | UI-000018の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000018 | Canonical |
| [SCR-000019](SCR-000019/screen.md) | UI-000019の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000019 | Canonical |
...
- 欠測や履歴を現在の正常値へ畳む表示、および正本と投影を区別しない表現。
