# SCR-000018 文書の物語・構造・図のNavigation

成果物種別: Logical Screen Detail
Screen ID: `SCR-000018`
状態: Canonical
維持責任者: Qual-Lab

## 1. Screenの目的と入口・終了条件

- 利用者の作業・認識目的: 課題から結論までを理解し、図と正本から次工程の意図を辿れる。
- 対象UI Definition: [UI-000018](../../../../Definitions/UI-000018/ui_definition.md)
- Area: [project-context](../area.md)
- 入口: 利用者が「文書の物語・構造・図のNavigation」を必要とし、対象Contextを識別できた時
- 終了条件: 課題から結論までを理解し、図と正本から次工程の意図を辿れる。 次の安全な行動または所有正本を選べる
...
```text
+---------------- SCR-000018 ----------------+
| PRT-000018  文書の物語・構造・図のNavigation |
...
|---|---|---|---|---|
| `PRT-000018` | 課題から結論までを理解し、図と正本から次工程の意図を辿れる。 | 対象、状態、根拠、不足、観測時点、次行動 | 概要を読む／図から詳細へ進む／正本を開く。 | ready／pending／blocked／unknown／restricted |

## 3. InteractionとBHV対応

| Interaction Key | PRT | 利用者の意図 | Feedback | BHV | Coverage |
|---|---|---|---|---|---|
| `PRT-000018.spec-000023` | PRT-000018 | 概要を読む／図から詳細へ進む／正本を開く。 | 受付、結果、失敗、判断不能および安全な次行動を区別する | [BHV-000023](../../../../../05_SPEC/Details/BHV-000023/behavior.md) | Covered |

## 4. State／Variant

| State／Variant | 発生条件 | 表示する意味 | 操作 | 回復／次の状態 |
|---|---|---|---|---|
| ready | 必要情報とAuthorityを確認できる | 安全に主要操作へ進める | 概要を読む／図から詳細へ進む／正本を開く。 | 結果を同じContextで確認 |
