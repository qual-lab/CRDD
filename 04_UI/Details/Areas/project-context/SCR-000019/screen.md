# SCR-000019 公式素材の由来・権利・用途確認

成果物種別: Logical Screen Detail
Screen ID: `SCR-000019`
状態: Canonical
維持責任者: Qual-Lab

## 1. Screenの目的と入口・終了条件

- 利用者の作業・認識目的: 素材の由来と許可された用途を確認して安心して使える。
- 対象UI Definition: [UI-000019](../../../../Definitions/UI-000019/ui_definition.md)
- Area: [project-context](../area.md)
- 入口: 利用者が「公式素材の由来・権利・用途確認」を必要とし、対象Contextを識別できた時
- 終了条件: 素材の由来と許可された用途を確認して安心して使える。 次の安全な行動または所有正本を選べる
...
|---|---|---|---|---|
| `PRT-000019` | 素材の由来と許可された用途を確認して安心して使える。 | 対象、状態、根拠、不足、観測時点、次行動 | 素材を見る／根拠を確認する／利用する。 | ready／pending／blocked／unknown／restricted |

## 3. InteractionとBHV対応

| Interaction Key | PRT | 利用者の意図 | Feedback | BHV | Coverage |
|---|---|---|---|---|---|
| `PRT-000019.spec-000024` | PRT-000019 | 素材を見る／根拠を確認する／利用する。 | 受付、結果、失敗、判断不能および安全な次行動を区別する | [BHV-000024](../../../../../05_SPEC/Details/BHV-000024/behavior.md) | Covered |

## 4. State／Variant

| State／Variant | 発生条件 | 表示する意味 | 操作 | 回復／次の状態 |
|---|---|---|---|---|
| ready | 必要情報とAuthorityを確認できる | 安全に主要操作へ進める | 素材を見る／根拠を確認する／利用する。 | 結果を同じContextで確認 |
