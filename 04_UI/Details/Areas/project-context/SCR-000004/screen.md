# SCR-000004 Project・節目・Portfolioの状況把握

成果物種別: Logical Screen Detail
Screen ID: `SCR-000004`
状態: Canonical
維持責任者: Qual-Lab

## 1. Screenの目的と入口・終了条件

- 利用者の作業・認識目的: 単一または複数Projectの現在地を根拠と不完全性付きで判断できる。
- 対象UI Definition: [UI-000004](../../../../Definitions/UI-000004/ui_definition.md)
- Area: [project-context](../area.md)
- 入口: 利用者が「Project・節目・Portfolioの状況把握」を必要とし、対象Contextを識別できた時
- 終了条件: 単一または複数Projectの現在地を根拠と不完全性付きで判断できる。 次の安全な行動または所有正本を選べる
...
```text
+---------------- SCR-000004 ----------------+
| PRT-000004  Project・節目・Portfolioの状況把握 |
...
|---|---|---|---|---|
| `PRT-000004` | 単一または複数Projectの現在地を根拠と不完全性付きで判断できる。 | 対象、状態、根拠、不足、観測時点、次行動 | Projectを選び、根拠を確認し、比較または判断する。 | ready／pending／blocked／unknown／restricted |

## 3. InteractionとBHV対応

| Interaction Key | PRT | 利用者の意図 | Feedback | BHV | Coverage |
|---|---|---|---|---|---|
| `PRT-000004.spec-000002` | PRT-000004 | Projectを選び、根拠を確認し、比較または判断する。 | 受付、結果、失敗、判断不能および安全な次行動を区別する | [BHV-000002](../../../../../05_SPEC/Details/BHV-000002/behavior.md) | Covered |
| `PRT-000004.spec-000006` | PRT-000004 | Projectを選び、根拠を確認し、比較または判断する。 | 受付、結果、失敗、判断不能および安全な次行動を区別する | [BHV-000006](../../../../../05_SPEC/Details/BHV-000006/behavior.md) | Covered |
| `PRT-000004.spec-000007` | PRT-000004 | Projectを選び、根拠を確認し、比較または判断する。 | 受付、結果、失敗、判断不能および安全な次行動を区別する | [BHV-000007](../../../../../05_SPEC/Details/BHV-000007/behavior.md) | Covered |

## 4. State／Variant

| State／Variant | 発生条件 | 表示する意味 | 操作 | 回復／次の状態 |
|---|---|---|---|---|
| ready | 必要情報とAuthorityを確認できる | 安全に主要操作へ進める | Projectを選び、根拠を確認し、比較または判断する。 | 結果を同じContextで確認 |
