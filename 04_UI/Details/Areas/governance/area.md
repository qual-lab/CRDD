...
- Areaの目的: 責務変更の利用側閉包と、監査・是正・試験・品質状態を同じ改訂版へ結び、工程判断の根拠を辿れるようにする。
- 主な利用者: CRDDを使って作業、確認または判断する人
- 保持する利用者成果: 責務変更の利用側閉包と、監査・是正・試験・品質状態を同じ改訂版へ結び、工程判断の根拠を辿れるようにする。
- 対象UI Definition: [UI-000014](../../../Definitions/UI-000014/ui_definition.md)、[UI-000015](../../../Definitions/UI-000015/ui_definition.md)
...
|---|---|---|---|---|---|
| [SCR-000014](SCR-000014/screen.md) | UI-000014の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000014 | Canonical |
| [SCR-000015](SCR-000015/screen.md) | UI-000015の利用者成果を一つの作業単位で扱う | 対象Contextを選んだ時 | 次の安全な行動を選べる | PRT-000015 | Canonical |
...
- 試験件数、一部監査のPassまたは代表Consumerだけから全体完了を示す表現。
