...
| 実Taskの取消と回復 | Ctrl+Cを1回入力して到達したが通常回収が失敗し、正規Recoveryで残った資源を回収 | [実測の順序と限界](../07_Quality/Verification_Results/2026-08-31_Coordinator_Closure_Verification.md#public-task-cancellation-observation)へ接続。取消入力の成立・通常回収不成立・事後回復成功を分け、競合是正後の再実測まで取消正常完了としない |
