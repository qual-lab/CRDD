...
| 実Taskの取消と回復 | 是正後の署名版4f10201で実端末Ctrl+C入力1回から通常回収まで観測。限定独立確認済み | [実測の順序と限界](../07_Quality/Verification_Results/2026-09-01_Coordinator_Signed_E2E.md)へ接続。旧版の通常回収失敗・事後回復と、是正後の限定成功を区別し、全取消タイミングの成立やUI全体合格へ一般化しない |
