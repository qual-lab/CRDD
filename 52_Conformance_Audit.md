...
| PL-17 | 外部向け成果物を作成、公開または測定する対象範囲では、受け手、目的、主張と根拠、デザイン方針、外部向け投影、公開判断、公開済み記録、訂正・撤回、測定から学び候補までを区別して追跡する。受け手、訴求、獲得経路、媒体、広告または市場反応を新設・変更し、認知、評価、試行、導入、継続または支持を目的とする場合は、課題探索・要求形成の市場探索レンズへ接続し、採用契機、採用上の役割、現在の代替、転換障壁、信用条件、チャネル意図、成果物の役割、反証および収束根拠を取得可能にする。職種・媒体属性と採用上の役割、観測値・代理指標・推定属性・本人申告、意味の異なる転換行動を混同せず、人間対象調査の選定偏りと一般化限界、探索的測定と確認的判断の違いを示す。外部反応を要求またはプロダクト上の事実へ自動昇格せず、公開可否とリスク受容を人間の決定権限へ残す。外部コミュニケーションを扱わない対象範囲では、理由と対象範囲を伴う`Not Applicable`として評価でき、`80_Communication`または空成果物を要求しない | [外部コミュニケーション](17_Communication.md)、[課題探索・要求形成](21_Discovery.md)、[文書化](03_Documentation.md)、[品質保証](16_Quality_Assurance.md) | 受け手と目的、採用を目的とする場合の契機・関係者・代替行動・障壁・信用条件・チャネル意図・成果物の役割、Discovery市場探索との接続、観測値・代理指標・推定属性・本人申告の区別、人間対象調査の対象選定・偏り・一般化限界・終了条件、主張と根拠、デザイン方針、外部向け投影、公開判断、公開済み記録、公開版、訂正・撤回、測定仮説・対象母集団・比較条件・指標・分母・標本根拠・停止規則、観察・仮説・学び候補、人間による採否、適用しない場合の理由と対象範囲 |
