...
| PL-17 | 外部向け成果物を作成、公開または測定する対象範囲では、受け手、目的、主張と根拠、デザイン方針、外部向け投影、公開判断、公開済み記録、訂正・撤回、測定から学び候補までを区別して追跡する。外部反応を要求またはプロダクト上の事実へ自動昇格せず、公開可否とリスク受容を人間の決定権限へ残す。外部コミュニケーションを扱わない対象範囲では、理由と対象範囲を伴う`Not Applicable`として評価でき、`80_Communication`または空成果物を要求しない | [外部コミュニケーション](17_Communication.md)、[文書化](03_Documentation.md)、[品質保証](16_Quality_Assurance.md) | 受け手と目的、主張と根拠、デザイン方針、外部向け投影、公開判断、公開済み記録、公開版、訂正・撤回、測定条件、観察・仮説・学び候補、人間による採否、適用しない場合の理由と対象範囲 |
