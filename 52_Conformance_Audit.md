...
| PL-17 | 外部向け成果物を作成、公開または測定する対象範囲では、受け手、目的、主張と根拠、デザイン方針、外部向け投影、公開判断、公開済み記録、訂正・撤回、測定から学び候補までを区別して追跡する。受け手、訴求、獲得経路、媒体、広告または市場反応を新設・変更し、認知、評価、試行、導入、継続または支持を目的とする場合は、課題探索・要求形成の市場探索レンズへ接続し、採用契機、採用上の役割、現在の代替、転換障壁、信用条件、チャネル意図、成果物の役割、反証および収束根拠を取得可能にする。この追加探索の目的または変更範囲を判定できない場合は、不足情報、確認担当および再評価条件を示して`Not Evaluated`とし、通常のCommunication契約まで未評価へ戻さず、非発火、`Not Applicable`または完了と扱わない。Discoveryが所有する対象セグメント・採用行動と、Communicationが所有する受け手・メッセージ・媒体・成果物・導線・測定仮説を分け、検討段階を固定状態遷移にしない。職種・媒体属性と採用上の役割、観測値・代理指標・推定属性・本人申告、意味の異なる転換行動を混同せず、人間対象調査の選定偏り、一般化限界と、探索的測定・確認的判断の違いを示す。追加市場探索の発火にかかわらず、Communicationで人間対象調査を行う場合は、21が所有する目的・利用範囲、同意、拒否・中断・撤回、回答圧力、情報最小化、再識別可能性および不利益防止を適用し、17での利用方法と分ける。外部行動を促す場合は約束した導線・成果物・対応・提供能力を根拠へ接続し、確認不能時の停止または代替を示す。外部反応から表現、UX、プロダクト、価格または運用の原因を直接確定せず、観測、原因候補、責務領域、必要な根拠と還流先を分ける。欺瞞、重要条件の隠蔽、過度な不安、根拠のない緊急性または意思を妨げる操作に依存せず、外部反応を要求またはプロダクト上の事実へ自動昇格しない。公開可否とリスク受容を人間の決定権限へ残す。外部コミュニケーションを扱わない対象範囲では、理由と対象範囲を伴う`Not Applicable`として評価でき、`80_Communication`または空成果物を要求しない | [外部コミュニケーション](17_Communication.md)、[課題探索・要求形成](21_Discovery.md)、[文書化](03_Documentation.md)、[品質保証](16_Quality_Assurance.md) | 受け手と目的、採用を目的とする場合の契機・関係者・代替行動・障壁・信用条件・チャネル意図・成果物の役割、Discovery市場探索との接続と責務分離、観測値・代理指標・推定属性・本人申告の区別、人間対象調査の対象選定・偏り・一般化限界・終了条件、発火有無に依存しない目的・利用範囲・同意・拒否・回答圧力・情報最小化・再識別可能性・不利益防止、主張と根拠、デザイン方針、外部向け投影、公開判断、公開済み記録、公開版、訂正・撤回、外部行動を促す場合の提供能力・停止・代替、説得上の重要条件と自律性、測定仮説・対象母集団・比較条件・指標・分母・標本根拠・停止規則、観察・原因候補・責務領域・必要根拠・学び候補・還流先、人間による採否、追加探索を評価できない場合の不足情報・確認担当・再評価条件、適用しない場合の理由と対象範囲 |
