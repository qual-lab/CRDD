...
| 履歴保持 | 公開済みの固定履歴であり、現在の案内または別の正本から補足すべきである |
| 確認不能 | 対象読者、決定権限または意味保持を判定する根拠が不足する |

公開済みの`CHG-*`、Evidence、CHANGELOGまたはRelease記録も監査母集団から除外しない。ただし、可読性改善を理由に当時の事実、判断、改訂版、結果または公式tagを遡及変更しない。固定履歴そのものを変えられない場合は、現行の索引、現在状態または明示した後続案内で探索負荷を下げ、履歴と現在説明を区別する。
