...
外部コミュニケーションを対象に含む場合は、現在生成できる外部向け投影と公開済み記録が分離され、主張から根拠と正本へ辿れ、公開後の測定、観察、仮説、学び候補、人間判断が同じ状態へ丸められていないか確認する。認知意図を適用する対象では、根拠付き仮説、必要な根拠／情報、当時と現在の意図、観測、履歴、AIへ投影した対象改訂版を辿れ、非発火例へ認知状態を作らず、判定情報不足をAIで補完していないか確認する。受け手、訴求、獲得経路、媒体、広告または市場反応を新設・変更し、かつ認知、評価、試行、導入、継続または支持の形成を目的とする場合は、課題探索・要求形成の市場探索レンズへ接続し、採用契機、関係者、現在の代替、転換障壁、信用条件、チャネル意図、成果物の役割、反証および収束根拠を取得できるか確認する。Discoveryの対象セグメント・採用行動・商業性とCommunicationの受け手・メッセージ・媒体・成果物・導線・測定仮説を分け、段階例を固定状態遷移にしていないか確認する。職種・媒体属性と採用上の役割、観測値・代理指標・推定属性・本人申告、意味の異なる転換行動を混同しない。追加市場探索の発火にかかわらず、Communicationで人間対象調査を行う場合は、21が所有する対象者の適格条件、選定・募集、偏り、対象外、一般化限界、継続・終了条件と、同意・拒否・回答圧力・再識別可能性・不利益防止、および17での利用方法へ到達できるか確認する。外部行動を促す場合は公開または行動喚起の前に提供能力と停止・代替導線へ接続し、反応から表現、UX、プロダクト、価格または運用の原因を直接確定せず、原因候補と還流先を分けているか確認する。説得、広告、推薦、個別化または再接触が、欺瞞、重要条件の隠蔽、過度な不安、根拠のない緊急性、意思を妨げる操作または対象者の脆弱性の不当利用へ依存せず、表示の識別可能性、選択・拒否・訂正および不利益を対象リスクに応じて確認しているかも見る。追加探索条件のいずれかが不成立なら、もう一方が不明でも非発火としているか確認する。成立しない条件がなく少なくとも一方を判定できない場合だけ、通常のCommunication責務まで未評価へ戻さず、不足情報、確認先および再開条件を伴う確認待ちとしているか確認する。管理対象のコンテキスト依存または成果物依存を含む場合は、依存の種別、参照版、上書き、競合、利用側、更新判断を取得でき、参照元とローカル正本が無言で競合していないか確認する。通常または推移的な実装依存の存在だけで完全契約を要求せず、[コンテキスト依存](18_Context_Dependency.md)が定める独立管理利用側間の横断調整または重大リスクを必要とする依存を無言で通常依存へ落としていないかも確認する。
