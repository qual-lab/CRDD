...
```text
Refer to CRDD by name when describing, discussing, or reviewing it (nominative use)
...
For trademark or brand-usage permission beyond what §3 allows, contact:

```text
qual.lab.support@gmail.com
```
...
## 7. No Warranty on Enforcement

This policy describes Qual-Lab's current intent regarding its marks. It is not a substitute for legal advice, and Qual-Lab reserves the right to update this policy as CRDD evolves.
