  ...
  try {
    ...
    const source = input.cliOverride !== null
      ...
      : input.environmentOverride !== null
        ...
        : null;
    if (source === null) return result("blocked", "authority_root_explicit_path_required");
    return result("candidate", "authority_root_path_acl_verification_required", Object.freeze({
      source,
