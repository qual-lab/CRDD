...
function pathCandidate(value: unknown): value is string {
  return (
    typeof value === "string" &&
    value.length > 0 &&
    value.length <= 4_096 &&
...
export function selectRuntimeRootCandidate(rawInput: unknown) {
  try {
...
export function describeRuntimeRootContract() {
  return Object.freeze({
    ...
    overridePrecedence: Object.freeze([
      "cli",
      "environment",
      "repository_default",
    ]),
