...
export function inspectWindowsPlatformAccessCandidate(
  ...
  void rootPath;
  void rootRole;
  return blocked("platform_access_release_binary_binding_not_implemented");
}
...
export function describePlatformAccessAdapterContract() {
  return Object.freeze({
    ...
    binaryReleaseIdentityBinding: "not_implemented",
    productionInvocation: "blocked_before_path_or_process_access",
