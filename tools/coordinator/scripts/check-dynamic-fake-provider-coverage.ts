...
const coverageObligations = Object.freeze({
  "tools/coordinator/src/security/docker-isolation.ts": obligation(
  ...
  "tools/coordinator/src/security/execution-environment.ts": obligation(
  ...
  "tools/coordinator/src/security/host-recovery-record.ts": obligation(
