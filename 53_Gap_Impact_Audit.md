...
| 外部コミュニケーション | 受け手、目的、主張と根拠、デザイン方針、外部向け投影、公開済み記録、訂正・撤回、測定と学び候補。対象受け手、訴求、獲得経路、媒体、広告または市場反応を新設・変更し、かつ認知、評価、試行、導入、継続または支持の形成を目的とする場合は、採用契機・関係者・代替行動・障壁とDiscovery市場探索も対象とする |
...
対象受け手等の変更かつ認知・評価・試行・導入・継続・支持形成目的のCommunication -> 採用仮説／Discovery市場探索 -> Communication表現／学び候補／責務を持つ正本
...
| 対象受け手等の変更かつ認知・評価・試行・導入・継続・支持形成目的 → Discovery市場探索／正本／根拠 → 採用仮説・外部表現 → 公開後の学び | [外部コミュニケーション](17_Communication.md)、[課題探索・要求形成](21_Discovery.md)、該当正本。追加探索の目的または変更範囲が不明なら、通常Communicationと分けて確認待ちにする |
