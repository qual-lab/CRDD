...
| 外部コミュニケーション | 受け手、目的、採用契機・関係者・代替行動・障壁、Discovery市場探索、主張と根拠、デザイン方針、外部向け投影、公開済み記録、訂正・撤回、測定と学び候補 |
...
変更トレース -> 工程承認／リリース／ロードマップ
共有要素 -> 利用先／バリアント／機能
外部コミュニケーション -> 採用仮説／Discovery市場探索／主張／公開成果物／測定 -> 学び候補／責務を持つ正本
...
| Discovery市場探索／正本／根拠 → 採用仮説・外部表現 → 公開後の学び | [外部コミュニケーション](17_Communication.md)、[課題探索・要求形成](21_Discovery.md)、該当正本 |
