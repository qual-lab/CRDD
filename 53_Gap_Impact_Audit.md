...
| 外部コミュニケーション | 受け手、目的、主張と根拠、デザイン方針、外部向け投影、公開済み記録、訂正・撤回、測定と学び候補。対象受け手、訴求、獲得経路、媒体、広告または市場反応を新設・変更し、かつ認知、評価、試行、導入、継続または支持の形成を目的とする場合は、採用契機・関係者・代替行動・障壁とDiscovery市場探索も対象とする。いずれか一方が不成立なら追加探索は非発火とし、成立しない条件がなく少なくとも一方が不明な場合だけ確認待ちを対象とする。外部行動を促す場合は公開前の提供能力・停止・代替、測定する場合は原因候補・責務領域・必要根拠・還流先を対象とする。追加市場探索の発火にかかわらず、人間対象調査を行う場合は21の対象者の適格条件、選定・募集、偏り、対象外、一般化限界、継続・終了条件と、同意・拒否・回答圧力・情報最小化・再識別可能性・不利益防止を対象とし、説得を行う場合は17の自律性・重要条件を対象とする |
