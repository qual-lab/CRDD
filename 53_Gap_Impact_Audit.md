...
[基準版採用評価](19_Maintenance.md#62-baseline-adoption-assessment)で、意味、AI挙動、工程、複数成果物または利用側への影響が不明な場合に本監査を使用する。CRDD基準版を更新するたびに本監査を一律実行せず、差分が軽微で影響範囲を説明できる場合は、基準版採用評価内の限定確認で終了できる。
